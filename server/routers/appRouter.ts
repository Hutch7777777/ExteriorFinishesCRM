  ...
  router.post('/customers.create', async (req, res) => {
    try {
      ...
      const customerData = {
        ...
        acquisitionSource: input.acquisitionSource || 'other',
        businessName: input.businessName || null,
        primaryContact: input.primaryContact || null,
        secondaryContact: input.secondaryContact || null,
        website: input.website || null,
        taxId: input.taxId || null,
        preferredCommunication: input.preferredCommunication || 'email',
        ...
        averageProjectSize: input.averageProjectSize || 0,
        projectCount: input.projectCount || 0,
        lastProjectDate: input.lastProjectDate ? new Date(input.lastProjectDate) : null,
  ...
  router.post('/customers.update', async (req, res) => {
    try {
      ...
      const inputSchema = z.object({
        ...
        averageProjectSize: z.number().optional(),
        projectCount: z.number().optional(),
        lastProjectDate: z.date().optional(),
      ...
      const updateData = {
        ...
        ...(input.acquisitionSource !== undefined && { acquisitionSource: input.acquisitionSource }),
        ...(input.businessName !== undefined && { businessName: input.businessName }),
        ...(input.primaryContact !== undefined && { primaryContact: input.primaryContact }),
        ...(input.secondaryContact !== undefined && { secondaryContact: input.secondaryContact }),
        ...
        ...(input.lifetimeValueCents !== undefined && { lifetimeValueCents: input.lifetimeValueCents }),
        ...(input.averageProjectSize !== undefined && { averageProjectSize: input.averageProjectSize }),
        ...(input.projectCount !== undefined && { projectCount: input.projectCount }),
        ...(input.lastProjectDate !== undefined && { lastProjectDate: input.lastProjectDate }),
        ...(input.satisfactionRating !== undefined && { satisfactionRating: input.satisfactionRating }),
        ...(input.referralCount !== undefined && { referralCount: input.referralCount }),
